...
from open_webui.routers.containers import AGENT_BEARER_TOKEN, _gateway_url, get_or_create_container
from open_webui.utils.artifact_triggers import (
    extract_path_from_tool_result,
    is_artifact_extension,
    is_artifact_trigger_tool,
)
from open_webui.utils.chat_tasks import background_tasks_handler
from open_webui.utils.hermes_media_persist import persist_and_rewrite, persist_tool_paths
from open_webui.utils.hermes_routing import resolve_user_agent_base
from open_webui.utils.output import extract_render_ui_from_content, output_id, serialize_output
