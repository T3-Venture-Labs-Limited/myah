...
async def _get_container_port(user: UserModel, path: str) -> int:
    ...
    from open_webui.utils.hermes_web import _resolve_chat_port, _resolve_gateway_port
...
async def aux_call(
    ...
    *,
    ...
    """
    from open_webui.routers.containers import AGENT_BEARER_TOKEN, AGENT_HOST
