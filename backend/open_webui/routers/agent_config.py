...
# via open_webui.utils.hermes_web. Two callsites stay on aux_call:
...
from open_webui.utils.agent_proxy import AUX_ALLOWED_TASKS, aux_call, normalize_catalog_models
