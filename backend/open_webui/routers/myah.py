...
async def whoami(request: Request) -> WhoAmIResponse:
    ...
    # [...], 'total': N}`` (current open_webui shape) or a plain list
    ...
    if deployment_mode == 'oss':
        try:
            from open_webui.models.user_provider_status import UserProviderStatuses
            from open_webui.utils.hermes_web import fetch_hermes_provider_catalog
    ...
    if deployment_mode == 'oss':
        try:
            from open_webui.utils.hermes_web import fetch_hermes_default_model
