...
from open_webui.routers import containers, processes, agent_capabilities, agent_sessions
from open_webui.routers import agent_config as agent_config_router
from open_webui.routers import hermes_media
from open_webui.routers import myah as myah_router_module
from open_webui.routers import providers as providers_router_module
...
from open_webui.utils.hermes_web import is_oss_mode as _is_oss_mode

if not _is_oss_mode():
    from open_webui.routers import agent_memory, integrations
...
from open_webui.utils.chat_payload import (
    process_chat_payload,
)
from open_webui.utils.chat_tasks import (
    build_chat_response_context,
)
from open_webui.utils.tool_servers import set_tool_servers
...
async def lifespan(app: FastAPI):
    ...
    if _is_oss_mode():
        ...
        try:
            import docker
            from open_webui.models.containers import Containers as _Containers
    ...
    try:
        from open_webui.utils.skill_compositions import load_skill_compositions
    ...
    from open_webui.env import SENTRY_DSN_PLATFORM as _sentry_dsn
...
async def chat_completion(
    ...
    async def process_chat(request, form_data, user, metadata, model):
        try:
            ...
            _tracer = _otel_trace.get_tracer('open_webui.chat')
            _pc_t0 = time.time()
