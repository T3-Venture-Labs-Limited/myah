...
def _load_containers_module(monkeypatch=None, argv=None):
    ...
    """
    constants = ModuleType('open_webui.constants')
    constants.ERROR_MESSAGES = {}

    models_containers = ModuleType('open_webui.models.containers')
    ...
    models_users = ModuleType('open_webui.models.users')
    models_users.UserModel = object

    services_honcho = ModuleType('open_webui.services.honcho')
    services_honcho.honcho_service = SimpleNamespace()

    utils_auth = ModuleType('open_webui.utils.auth')
    ...
    stub_modules = {
        ...
        'open_webui.models.containers': models_containers,
        'open_webui.models.users': models_users,
        'open_webui.services.honcho': services_honcho,
...
class TestWebhookPortDetection:
    ...
    def test_detects_port_from_uvicorn_cli_arg(self, monkeypatch):
        ...
        containers = _load_containers_module(argv=['uvicorn', 'open_webui.main:app', '--port', '8082'])
