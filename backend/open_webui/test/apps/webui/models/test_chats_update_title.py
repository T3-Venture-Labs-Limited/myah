...
# Must be set before any open_webui import so env.py picks them up.
...
def db_session():
    ...
    Also patches `open_webui.internal.db.SessionLocal` so that
    ...
    from open_webui.models.chats import Chat  # noqa: F401 — registers table in metadata
