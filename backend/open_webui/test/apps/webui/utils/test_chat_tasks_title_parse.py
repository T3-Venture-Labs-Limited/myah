...
def _load_chat_tasks_module():
    ...
    spec = importlib.util.spec_from_file_location('open_webui.utils.chat_tasks', chat_tasks_path)
    module = importlib.util.module_from_spec(spec)
    sys.modules['open_webui.utils.chat_tasks'] = module
    spec.loader.exec_module(module)
    module._stub_keys = list(mods.keys()) + ['open_webui.utils.chat_tasks']
    return module
