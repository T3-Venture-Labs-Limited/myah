...
async def test_background_path_emits_socket_events():
    ...
    with (
        patch('open_webui.utils.hermes_stream_handler.Chats'),
        patch('open_webui.utils.hermes_stream_handler.background_tasks_handler', new=AsyncMock()),
    ):
        from open_webui.utils.hermes_stream_handler import handle_hermes_stream
...
def _clear_registries():
    ...
    import open_webui.utils.hermes_stream_handler as _mod
...
async def test_active_runs_populated_on_run_started():
    ...
    with (
        patch('open_webui.utils.hermes_stream_handler.Chats'),
        patch('open_webui.utils.hermes_stream_handler.background_tasks_handler', new=AsyncMock()),
        patch('open_webui.utils.hermes_stream_handler.asyncio.get_running_loop', return_value=fake_loop),
    ):
        import open_webui.utils.hermes_stream_handler as _mod
        from open_webui.utils.hermes_stream_handler import handle_hermes_stream
