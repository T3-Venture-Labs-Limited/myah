...
def db_session():
    ...
    test_hermes_web.py imports ``myah.config`` which redefines
    classes against the same Base — see the SAWarning emitted there).
    """
    from sqlalchemy import create_engine
    from sqlalchemy.orm import sessionmaker
    from myah.models.containers import Container  # registers the table
...
def test_update_status_accepts_web_kwargs(db_session):
    ...
    import inspect
    from myah.models.containers import ContainerTable
