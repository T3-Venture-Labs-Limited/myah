...
def cleanup_fn():
    ...
    stubs = {
        'myah.models.chats': MagicMock(),
        'myah.models.tags': MagicMock(),
        'myah.models.folders': MagicMock(),
        'myah.models.files': MagicMock(),
        'myah.storage.provider': MagicMock(),
        'myah.internal.db': MagicMock(),
        'myah.config': MagicMock(),
        'myah.constants': MagicMock(),
        'myah.utils.auth': MagicMock(),
        'myah.utils.access_control': MagicMock(),
        'myah.utils.misc': MagicMock(),
        'myah.socket.main': MagicMock(),
        'fastapi': MagicMock(),
