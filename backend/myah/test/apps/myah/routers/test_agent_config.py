# Tests for myah/routers/agent_config.py — the /api/v1/agent/* proxy endpoints.
...
def _load_agent_config_module():
    """Load myah/routers/agent_config.py with all heavy deps stubbed."""
    ...
    spec = importlib.util.spec_from_file_location('myah.routers.agent_config', router_path)
    module = importlib.util.module_from_spec(spec)
    sys.modules['myah.routers.agent_config'] = module
