...
>
	<Switch.Root
		...
		{disabled}
		class="flex h-[1.125rem] min-h-[1.125rem] w-8 shrink-0 items-center rounded-full px-1 mx-[1px] transition  {disabled
			? 'cursor-not-allowed opacity-60'
			: 'cursor-pointer'} {($settings?.highContrastMode ?? false)
