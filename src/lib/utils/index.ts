...
export const convertMessagesToHistory = (messages) => {
	...
	// Deduplicate by content identity before building the tree — the same
	// message can appear twice if both chatContent.history and chatContent.messages
	// are present and overlap, causing Svelte's keyed {#each} to crash with
	// each_key_duplicate when both share the same generated UUID.
