...
export const uploadFile = async (
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/files/?${searchParams.toString()}`, {
		method: 'POST',
		headers: {
...
export const getFileProcessStatus = async (token: string, id: string) => {
	...
	let error = null;
	const res = await fetch(`${MYAH_API_BASE_URL}/files/${id}/process/status?${queryParams}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			authorization: `Bearer ${token}`
...
export const uploadDir = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/files/upload/dir`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			authorization: `Bearer ${token}`
...
export const searchFiles = async (
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/files/search?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFileById = async (token: string, id: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/files/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateFileDataContentById = async (token: string, id: string, content: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/files/${id}/data/content/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getFileContentById = async (id: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/files/${id}/content`, {
		method: 'GET',
		headers: {
			Accept: 'application/json'
		},
...
export const deleteAllFiles = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/files/all`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
