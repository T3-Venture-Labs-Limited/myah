...
export const getAdminDetails = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/admin/details`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
...
export const getAdminConfig = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/admin/config`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getSessionUser = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const ldapUserSignIn = async (user: string, password: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/ldap`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const userSignIn = async (email: string, password: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/signin`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const userSignUp = async (
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/signup`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const userSignOut = async () => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/signout`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json'
		},
...
export const addUser = async (
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/add`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
...
export const updateUserProfile = async (token: string, profile: object) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/update/profile`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			...(token && { authorization: `Bearer ${token}` })
...
export const updateUserTimezone = async (token: string, timezone: string) => {
	await fetch(`${MYAH_API_BASE_URL}/auths/update/timezone`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			...(token && { authorization: `Bearer ${token}` })
...
export const updateUserPassword = async (token: string, password: string, newPassword: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/update/password`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			...(token && { authorization: `Bearer ${token}` })
...
export const getSignUpEnabledStatus = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/signup/enabled`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getDefaultUserRole = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/signup/user/role`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const toggleSignUpEnabledStatus = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/signup/enabled/toggle`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const getJWTExpiresDuration = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/token/expires`, {
		method: 'GET',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const updateJWTExpiresDuration = async (token: string, duration: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/token/expires/update`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
...
export const createAPIKey = async (token: string) => {
	...
	const res = await fetch(`${MYAH_API_BASE_URL}/auths/api_key`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			Authorization: `Bearer ${token}`
